...
<header class="navbar navbar-expand-md navbar-light d-print-none">
    <div class="container-xl">
        ...
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href="{{ route('acceuil') }}">{{ config('app.name') }}</a>
        </h1>
        ...
        <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    <a href="{{ route('editProfil') }}" class="dropdown-item">Paramètres</a>
                    <div class="">
...
<header class="navbar-expand-md">
    <div class="collapse navbar-collapse" id="navbar-menu">
        <div class="navbar navbar-light">
            <div class="container-xl">
                <ul class="navbar-nav">
                    <li class="nav-item  {{ Request::is('tableau-de-bord') ? 'active':'' }} ">
                    ...
                    <li class="nav-item   {{ Request::is('tableau-de-bord/publications') ? 'active':'' }} ">
                    ...
                    <li class="nav-item   {{ Request::is('tableau-de-bord/signalisations') ? 'active':'' }} ">
                        <a class="nav-link" href="{{ route('signalisations') }}">
                            <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/checkbox -->
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-traffic-lights-off" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                    <path d="M8 4c.912 -1.219 2.36 -2 4 -2a5 5 0 0 1 5 5v6m0 4a5 5 0 0 1 -10 0v-10"></path>
                                    <path d="M12 8a1 1 0 1 0 -1 -1"></path>
                                    <path d="M11.291 11.295a1 1 0 0 0 1.418 1.41"></path>
