                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <div class="font-weight-medium">
                                            @if($posts_count > 0)
                                            {{ $posts_count }} Article(s) publiés
                                            @else
                                            Aucun article disponible
                                            @endif
                                        </div>
                                        <div class="text-muted">
                                            jettez un coup d'oeil aux <a class="" href="{{ route('publications') }}"> publications.</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <div class="font-weight-medium">
                                            ...
                                            @if($category_count > 0)
                                            {{ $category_count }} Catégorie(s) publiées
                                            @else
                                        ...
                                        <div class="text-muted">
                                            Créez une <a class="" href="{{ route('category.create') }}"> catégorie</a> ou ajoutez un <a class="" href="{{ route('article.create') }}">article</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
